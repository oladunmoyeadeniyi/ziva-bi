...
*End of Master Context. Last updated: 2026-08-15 — All TIER 0–4 modules + post-launch ops modules + Employee Advance module shipped (commit `850ad25`, migration `b1c2d3e4f5g6`). Platform is fully feature-complete. For current schema/endpoint facts, see `docs/PROJECT_STATE.md`.*
