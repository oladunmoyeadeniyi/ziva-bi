                  ...
                  <div className="flex-1 min-w-0" onClick={(e) => e.stopPropagation()}>
                    {cfg.coding_level === 0 ? (
                      ...
                      <button type="button"
                        onClick={() => canEdit && setPickerFor({ lineLocalId: line.localId })}
                        disabled={!canEdit}
                        className={`w-full flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-md text-xs font-semibold border-2 transition-colors disabled:opacity-70 disabled:cursor-default ${isIncomplete ? "border-red-400 text-red-600 hover:bg-red-50" : "border-blue-400 text-blue-600 hover:bg-blue-50"}`}>
